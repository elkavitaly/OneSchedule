...
namespace OneSchedule.Domain.StateMachine
{
    ...
    public class FindStateContext : IStateContext
    {
        private const string NextState = "AskEventList";
        ...
        public FindStateContext(IEnumerable<IState> states, IRepository<ContextEntity> contextRepository)
        {

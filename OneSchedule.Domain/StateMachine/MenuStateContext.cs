...
namespace OneSchedule.Domain.StateMachine
{
    ...
    public class MenuStateContext : IStateContext
    {
        private const string NextState = "AskMainMenu";
        ...
        public MenuStateContext(IEnumerable<IState> states, IRepository<ContextEntity> contextRepository)
        {
